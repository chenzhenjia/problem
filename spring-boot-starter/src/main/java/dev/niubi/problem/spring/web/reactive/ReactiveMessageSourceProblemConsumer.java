...
public class ReactiveMessageSourceProblemConsumer extends
    AbstractMessageSourceProblemFunction<ServerWebExchange> implements
    ReactiveProblemConsumer {

  public ReactiveMessageSourceProblemConsumer(MessageSource messageSource) {
    super(messageSource);
  }
