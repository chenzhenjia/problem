...
public class ResponseStatusExceptionConverter implements
    ExceptionConverter<ResponseStatusException> {

  @Override
  public Problem toProblem(@NotNull ResponseStatusException exception) {
